...
export function SettingOut({ found }: SceneArtProps) {
  ...
  return (
    <>
      ...
      {found.includes("nets") && <Sparkle x={720} y={280} s={1.5} />}
      <Grain opacity={0.05} />
    </>
  );
}
...
export function AsleepInTheStern({ found }: SceneArtProps) {
  ...
  return (
    <>
      ...
      <Wave x={470} y={640} scale={0.45} cls="a-heave" delay={0.9} />
...
export function TheWildNight({ found }: SceneArtProps) {
  ...
  return (
    <>
      ...
      <Wave x={460} y={645} scale={0.5} cls="a-heave" delay={1.1} />
...
export function QuietBeStill({ found }: SceneArtProps) {
  ...
  return (
    <>
      ...
      <Ripple x={470} y={640} scale={0.5} delay={1} />
...
export function WhoIsThis({ found }: SceneArtProps) {
  ...
  return (
    <>
      ...
      <Ripple x={470} y={640} scale={0.5} delay={1.5} />
