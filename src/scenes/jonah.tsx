          ...
          <g className="a-rock">
            ...
            <g transform="translate(-70 -140)">
              <g className="a-shake">
                <image
                  href={stormSailors}
                  x={-S["sailors-afraid"].w * sc * 0.5}
                  y={-S["sailors-afraid"].h * sc}
                  width={S["sailors-afraid"].w * sc}
                  height={S["sailors-afraid"].h * sc}
                />
                <g
                  transform={`translate(${-S["sailors-afraid"].w * sc * 0.5} ${-S["sailors-afraid"].h * sc}) scale(${sc})`}
                >
            ...
            <g transform="translate(80 -150)">
              <g className="a-breathe">
                <image
                  href={stormJonah}
                  x={-S["jonah-point-self"].w * 0.13}
                  y={-S["jonah-point-self"].h * 0.26}
                  width={S["jonah-point-self"].w * 0.26}
                  height={S["jonah-point-self"].h * 0.26}
                />
                <g
                  transform={`translate(${-S["jonah-point-self"].w * 0.13} ${-S["jonah-point-self"].h * 0.26}) scale(0.26)`}
                >
            ...
            <image
              href={stormShip}
              x={-S["ship-storm"].w * shipS * 0.5}
              y={-S["ship-storm"].h * shipS}
              width={S["ship-storm"].w * shipS}
              height={S["ship-storm"].h * shipS}
            />
          </g>
        </g>
      </g>
    ...
    <>
      ...
      <g transform="translate(660 500)">
        <g className="a-swim-slow">
          <image
            href={swFish}
            x={-L["great-fish"].w * fishS * 0.5}
            y={-L["great-fish"].h * fishS * 0.5}
            width={L["great-fish"].w * fishS}
            height={L["great-fish"].h * fishS}
          />
          <g
            transform={`translate(${-L["great-fish"].w * fishS * 0.5} ${-L["great-fish"].h * fishS * 0.5}) scale(${fishS})`}
          >
      ...
      <g transform="translate(372 528)">
        <g className="a-swallow">
          <image
            href={swJonah}
            x={-L["jonah-fall"].w * 0.14}
            y={-L["jonah-fall"].h * 0.14}
            width={L["jonah-fall"].w * 0.28}
            height={L["jonah-fall"].h * 0.28}
          />
          <g
            transform={`translate(${-L["jonah-fall"].w * 0.14} ${-L["jonah-fall"].h * 0.14}) scale(0.28)`}
          >
    ...
    <>
      ...
      <g transform="translate(230 600)">
        <g className="a-swim">
          <image
            href={prayFish}
            x={-L["little-fish"].w * 0.14}
            y={-L["little-fish"].h * 0.28}
            width={L["little-fish"].w * 0.28}
            height={L["little-fish"].h * 0.28}
          />
          <g
            transform={`translate(${-L["little-fish"].w * 0.14} ${-L["little-fish"].h * 0.28}) scale(0.28)`}
          >
